...
export type RolUsuario = "admin" | "manager" | "contributor";
...
export const usuarios: Usuario[] = [
  { id: "U1", nombre: "Hugo Arboleda", correo: "hugo.arboleda@icesi.edu.co", rol: "manager", departamento: "Departamento de Computación y Sistemas inteligentes.", estado: "activo", ultimoAcceso: "2026-04-14" },
  { id: "U2", nombre: "Rocío Segovia", correo: "rsegovia@icesi.edu.co", rol: "contributor", departamento: "DCSI", estado: "activo", ultimoAcceso: "2026-04-13" },
  { id: "U3", nombre: "Luisa Torres Arango", correo: "ltorres@icesi.edu.co", rol: "contributor", departamento: "DDI", estado: "activo", ultimoAcceso: "2026-04-12" },
  { id: "U4", nombre: "Andrés Castillo Ríos", correo: "acastillo@icesi.edu.co", rol: "contributor", departamento: "DM", estado: "activo", ultimoAcceso: "2026-04-10" },
  { id: "U5", nombre: "Carlos Martínez Leal", correo: "cmartinez@icesi.edu.co", rol: "contributor", departamento: "DCSI", estado: "activo", ultimoAcceso: "2026-04-14" },
  { id: "U6", nombre: "Ana López Quintero", correo: "alopez@icesi.edu.co", rol: "contributor", departamento: "DCSI", estado: "activo", ultimoAcceso: "2026-04-13" },
  { id: "U7", nombre: "Jorge Vargas Peña", correo: "jvargas@icesi.edu.co", rol: "manager", departamento: "DCSI", estado: "activo", ultimoAcceso: "2026-04-11" },
  { id: "U8", nombre: "María Fernández Rueda", correo: "mfernandez@icesi.edu.co", rol: "contributor", departamento: "DCSI", estado: "activo", ultimoAcceso: "2026-04-09" },
  { id: "U9", nombre: "Patricia Gómez Vidal", correo: "pgomez@icesi.edu.co", rol: "manager", departamento: "Departamento de Diseño e Innovación", estado: "activo", ultimoAcceso: "2026-04-14" },
  ...
  { id: "U11", nombre: "Felipe Morales Castro", correo: "fmorales@icesi.edu.co", rol: "contributor", departamento: "DDI", estado: "inactivo", ultimoAcceso: "2025-11-20" },
  { id: "U12", nombre: "Leonardo Bustamante", correo: "lbustamante@icesi.edu.co", rol: "contributor", departamento: "DCSI", estado: "activo", ultimoAcceso: "2026-04-14" },
];
...
export const getLabelRol = (rol: RolUsuario) => ({ admin: "Administrador", manager: "Gestor estratégico", contributor: "Colaborador" }[rol]);
